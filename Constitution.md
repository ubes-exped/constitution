...
7. The default system of voting shall be First Past the Post ("FPTP"), for ease of counting only. Where FPTP is used as the system of voting, it shall be defined as follows.
   1. Eligible voters shall cast (up to) the same number of votes as there are positions to be filled.
   2. Each vote shall be a mark next to the selected candidate(s).
   3. In a multi-position election, each voter may not vote more than once for any candidate. 
